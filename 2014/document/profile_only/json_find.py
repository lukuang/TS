...
def prepare_data(alpha, distribution, words, background):
...
def main():
    ...
    for qid in queries:
        ...
        doc_result_list = []
        size = 0
        query_model, background_model = prepare_data(para["alpha"], para["distribution"], queries[qid]._words, para["background"])
