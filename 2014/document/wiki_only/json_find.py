...
def prepare_data(alpha, words, background, expansion_terms):
...
def main():
    ...
    for qid in queries:
        ...
        doc_result_list = []
        size = 0
        query_model, background_model = prepare_data(para["alpha"], queries[qid]._words, para["background"], expansion_terms[qid])
