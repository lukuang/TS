...
def main():
    ...
    for qid in queries:
        ...
        for d in queries[qid]._dirs:
            print d
        query_model, background_model, stopwords = prepare_data(para["alpha"], para["belta"],para["distribution"], queries[qid]._words, para["background"], para["stopwords"], expansion_terms[qid])
